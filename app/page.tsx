          ...
          <div className="container">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Gather opinions, make decisions, and engage your community with our modern polling platform. 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    See poll results update instantly as people vote. No refresh needed.
                  </CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Create public polls to engage your community or keep them private for internal use.
                  </CardDescription>
                </CardHeader>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Get detailed insights with beautiful charts and voting statistics.
                  </CardDescription>
                </CardHeader>
              </Card>
            </div>
